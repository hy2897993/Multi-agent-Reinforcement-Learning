...
def main(n_cpus, n_gpus, env_name,
    ...
    ray.init(num_cpus=n_cpus, num_gpus=n_gpus, local_mode=debug, object_store_memory = 200*1024*1024)
    ...
    checkpoint = 'logs/train_agents_IMPALA_restore_3_vs_3_auto_GK_independent_5000000_fifo_fixed\IMPALA_3_vs_3_auto_GK_d7c37_00000_0_2022-07-14_22-46-47\checkpoint_010700\checkpoint-10700'
    debug = False
    algorithm = "IMPALA"
    config = {}
    config_dir = os.path.dirname(checkpoint)
    print(config_dir)
    config_path ="logs\train_agents_IMPALA_restore_3_vs_3_auto_GK_independent_5000000_fifo_fixed\IMPALA_3_vs_3_auto_GK_d7c37_00000_0_2022-07-14_22-46-47\params.pkl"
    print(config_path)
